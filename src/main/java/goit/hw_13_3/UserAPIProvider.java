...
public class UserAPIProvider implements UserAPIProviderInterface {
    ...
    public List<Post> getAllPostsByUser(int userId) {
        HttpRequest httpRequest = HttpRequest
                .newBuilder(URI.create(USER_API_URL + "/" + userId + "/posts"))
                .GET()
                .build();
    ...
    @Override
    public List<Task> getAllUncompletedTasks(int userId) {
        HttpRequest httpRequest = HttpRequest
                .newBuilder(URI.create(USER_API_URL + "/" + userId + "/todos?completed=false"))
                .GET()
                .build();
        ...
        try {
            ...
            if (isResponseCode2xx(httpResponse.statusCode())) {
